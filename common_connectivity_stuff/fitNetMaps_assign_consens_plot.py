...
def main(sub,bids_folder = '/mnt_AdaBD_largefiles/Data/SMILE_Data/DNumRisk/ds-stressrisk',
...
if __name__ == '__main__':  
    ...
    parser.add_argument('--bids_folder', default='/mnt_AdaBD_largefiles/Data/SMILE_Data/DNumRisk/ds-stressrisk', type=str, help='BIDS folder path')
    ...
    parser.add_argument('--task', default='risk', type=str, help='Task name')
